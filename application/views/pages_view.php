    ...
    <body>
        ...
        <div class="container">
	        <div class="jumbotron">
  			...
  			<!-- <pre><code> -->
  			<?php 
  			$fields = array('name', 'page_code', 'children', 'other_links', 'only_show_page_if', 'page_awards_badge', 'grab'); 
  			//$output .= '<table>';
  			$output .= "<div style='float: left;'><div class='slideshow-container'>";
  			$totalslides = count($pages);
				for($i=0; $i<count($pages); $i++){
					//$output .= '<tr>';
					$currentslide = ($i+1);
					$output .= "<div class='mySlides'>";
					$output .=  "<div class='numbertext'>$currentslide / $totalslides</div>";
					$text = '';
					foreach($fields as $fieldname){
						
						switch ($fieldname){
							case "name":
								$text .= $pages[$i][$fieldname]. " &nbsp;";
								$gotoSlide .= "<a onclick='gotoSlide($currentslide)'>Go to slide ".$pages[$i][$fieldname]."</a><br>";
								break;
							case "grab":
									$output .= "<img src = '".$pages[$i][$fieldname]."' style='width:700px;'>";
								break;
							case "page_code":
								//$text .= "Code: " . $pages[$i][$fieldname];
								break;
							case "children":
								break;
							case "other_links":
								break;
							case "only_show_page_if":
								break;
								case "page_awards_badge":
								break;
							case "only_show_page_if":
								break;
        ...
        <?php echo "<div style='float:right;'>".$gotoSlide."</div>";?>
